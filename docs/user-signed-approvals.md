...
<div class="callout">
  ...
  <code>consume</code> also gains a required <code>consumer_token</code>. Both SDKs move to
  <code>1.0.0</code>; see <a href="#upgrading">Upgrading</a>.</p>
</div>
...
Both packages move to `1.0.0`. Two breaking changes:
