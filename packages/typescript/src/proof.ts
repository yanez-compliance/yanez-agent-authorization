 ...
 * Both sides are normalized before comparison. The route and the receipt claim both spell
 * keys `0x` + lowercase hex, but a key from any other source may drop the prefix or change
 * case, and a raw string compare then silently reports it as unregistered.
 *
